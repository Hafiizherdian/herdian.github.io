...
const Hero = () => {
  return (
    <div className="relative pt-24 pb-16 bg-white dark:bg-black text-gray-900 dark:text-white sm:pb-20 lg:pt-32 lg:pb-56">
      <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center mt-10 gap-4">
            ...
            <a
              href="#projects"
              className="px-6 py-3 text-sm font-semibold transition-all border rounded-md text-cyan-600 dark:text-cyan-400 border-cyan-600 dark:border-cyan-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 focus:ring-offset-white dark:focus:ring-offset-black focus:outline-none"
            >
        ...
        <div className="grid max-w-3xl grid-cols-1 gap-6 mx-auto mt-16 text-sm sm:grid-cols-2 lg:grid-cols-4 lg:max-w-5xl">
          ...
          >
            <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 rounded-lg bg-cyan-100 dark:bg-cyan-900/30 text-cyan-600 dark:text-cyan-400 group-hover:bg-cyan-200/50 dark:group-hover:bg-cyan-400/10 group-hover:text-cyan-700 dark:group-hover:text-cyan-300">
          ...
          >
            ...
            <div className="ml-4">
              ...
              <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">hafiizh-herdian</p>
            </div>
          </a>

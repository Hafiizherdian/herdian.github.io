...
const Footer = () => {
  ...
  const socialLinks = [
    {
      ...
      href: 'https://github.com/hafiizhherdian',
      ariaLabel: 'Visit my GitHub profile'
    },
    {
      name: 'LinkedIn',
      icon: <FaLinkedin className="w-5 h-5" />,
      href: 'https://linkedin.com/in/hafiizhherdian',
  ...
  return (
    <footer className="bg-gray-50 dark:bg-black py-12 border-t border-gray-200 dark:border-gray-800">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li className="flex items-start">
                <svg className="w-4 h-4 mt-1 mr-2 text-cyan-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+6281931339853" className="hover:text-cyan-400 transition-colors duration-300">
                  +62 819-3133-9853
                </a>
              </li>
              <li className="flex items-start">
                ...
                <a href="mailto:hafiizh.herdian@gmail.com" className="hover:text-cyan-400 transition-colors duration-300">
